...
// Mock data mapping
const spotData = {
  '1': { title: 'Hidden Waterfall just few Km in', category: 'Secret Spots', desc: '"Tucked away behind the old ruins, this waterfall is a perfect peaceful escape. The water is crystal clear and freezing cold!"', images: ['https://images.unsplash.com/photo-1432405972618-c60002a157c6'], lat: 34.0522, lng: -118.2437 },
